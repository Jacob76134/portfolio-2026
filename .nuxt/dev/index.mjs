...
import { defineEventHandler, handleCacheHeaders, splitCookiesString, createEvent, fetchWithEvent, isEvent, eventHandler, setHeaders, sendRedirect, proxyRequest, getRequestHeader, setResponseHeaders, setResponseStatus, send, getRequestHeaders, setResponseHeader, appendResponseHeader, getRequestURL, getResponseHeader, removeResponseHeader, createError, getQuery as getQuery$1, readBody, getRouterParam, setHeader, getResponseStatus, createApp, createRouter as createRouter$1, toNodeListener, lazyEventHandler, getResponseStatusText } from 'file://C:/Users/Jacob/homework/jacob-dev/node_modules/h3/dist/index.mjs';
import { escapeHtml } from 'file://C:/Users/Jacob/homework/jacob-dev/node_modules/@vue/shared/dist/shared.cjs.js';
import { createRenderer, getRequestDependencies, getPreloadLinks, getPrefetchLinks } from 'file://C:/Users/Jacob/homework/jacob-dev/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { parseURL, withoutBase, joinURL, getQuery, withQuery, withTrailingSlash, decodePath, withLeadingSlash, withoutTrailingSlash, joinRelativeURL } from 'file://C:/Users/Jacob/homework/jacob-dev/node_modules/ufo/dist/index.mjs';
import { renderToString } from 'file://C:/Users/Jacob/homework/jacob-dev/node_modules/vue/server-renderer/index.mjs';
import { klona } from 'file://C:/Users/Jacob/homework/jacob-dev/node_modules/klona/dist/index.mjs';
import defu, { defuFn } from 'file://C:/Users/Jacob/homework/jacob-dev/node_modules/defu/dist/defu.mjs';
import destr, { destr as destr$1 } from 'file://C:/Users/Jacob/homework/jacob-dev/node_modules/destr/dist/index.mjs';
import { snakeCase } from 'file://C:/Users/Jacob/homework/jacob-dev/node_modules/scule/dist/index.mjs';
import { createHead as createHead$1, propsToString, renderSSRHead } from 'file://C:/Users/Jacob/homework/jacob-dev/node_modules/@nuxt/nitro-server/node_modules/unhead/dist/server.mjs';
import { stringify, uneval } from 'file://C:/Users/Jacob/homework/jacob-dev/node_modules/devalue/index.js';
import { isVNode, isRef, toValue } from 'file://C:/Users/Jacob/homework/jacob-dev/node_modules/vue/index.mjs';
import { DeprecationsPlugin, PromisesPlugin, TemplateParamsPlugin, AliasSortingPlugin } from 'file://C:/Users/Jacob/homework/jacob-dev/node_modules/nuxt/node_modules/unhead/dist/plugins.mjs';
import { createHooks } from 'file://C:/Users/Jacob/homework/jacob-dev/node_modules/hookable/dist/index.mjs';
import { createFetch, Headers as Headers$1 } from 'file://C:/Users/Jacob/homework/jacob-dev/node_modules/ofetch/dist/node.mjs';
import { fetchNodeRequestHandler, callNodeRequestHandler } from 'file://C:/Users/Jacob/homework/jacob-dev/node_modules/node-mock-http/dist/index.mjs';
import { createStorage, prefixStorage } from 'file://C:/Users/Jacob/homework/jacob-dev/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file://C:/Users/Jacob/homework/jacob-dev/node_modules/unstorage/drivers/fs.mjs';
import { digest } from 'file://C:/Users/Jacob/homework/jacob-dev/node_modules/ohash/dist/index.mjs';
import { toRouteMatcher, createRouter } from 'file://C:/Users/Jacob/homework/jacob-dev/node_modules/radix3/dist/index.mjs';
import { readFile } from 'node:fs/promises';
import consola, { consola as consola$1 } from 'file://C:/Users/Jacob/homework/jacob-dev/node_modules/consola/dist/index.mjs';
import { ErrorParser } from 'file://C:/Users/Jacob/homework/jacob-dev/node_modules/youch-core/build/index.js';
import { Youch } from 'file://C:/Users/Jacob/homework/jacob-dev/node_modules/youch/build/index.js';
import { SourceMapConsumer } from 'file://C:/Users/Jacob/homework/jacob-dev/node_modules/source-map/source-map.js';
import { AsyncLocalStorage } from 'node:async_hooks';
import { getContext } from 'file://C:/Users/Jacob/homework/jacob-dev/node_modules/unctx/dist/index.mjs';
import { captureRawStackTrace, parseRawStackTrace } from 'file://C:/Users/Jacob/homework/jacob-dev/node_modules/errx/dist/index.js';
import _wH6JrtIxmaSoA8lCPWFnE9z4lQeXW6H5z3l5aymEQw from 'file://C:/Users/Jacob/homework/jacob-dev/node_modules/@nuxt/vite-builder/dist/fix-stacktrace.mjs';
import { promises } from 'node:fs';
import { fileURLToPath } from 'node:url';
import { dirname as dirname$1, resolve as resolve$1 } from 'file://C:/Users/Jacob/homework/jacob-dev/node_modules/pathe/dist/index.mjs';
import { walkResolver } from 'file://C:/Users/Jacob/homework/jacob-dev/node_modules/@nuxt/nitro-server/node_modules/unhead/dist/utils.mjs';
import { isAbsolute } from 'file://C:/Users/Jacob/homework/jacob-dev/node_modules/@nuxt/content/node_modules/pathe/dist/index.mjs';
import localAdapter from 'file://C:/Users/Jacob/homework/jacob-dev/node_modules/db0/dist/connectors/better-sqlite3.mjs';

const serverAssets = [{"baseName":"server","dir":"C:/Users/Jacob/homework/jacob-dev/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"C:/Users/Jacob/homework/jacob-dev","watchOptions":{"ignored":[null]}}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"C:/Users/Jacob/homework/jacob-dev/server","watchOptions":{"ignored":[null]}}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"C:/Users/Jacob/homework/jacob-dev/.nuxt"}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"C:/Users/Jacob/homework/jacob-dev/.nuxt/cache"}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"C:/Users/Jacob/homework/jacob-dev/.data/kv"}));
...
const _inlineRuntimeConfig = {
  ...
  "nitro": {
    ...
    "routeRules": {
      ...
      "/__nuxt_content/work/sql_dump.txt": {
        "prerender": true
      },
      ...
      "/__nuxt_content/work/sql_dump.txt/_payload.json": {
        "prerender": true
      },
  ...
  "content": {
    ...
    "localDatabase": {
      "type": "sqlite",
      "filename": "C:/Users/Jacob/homework/jacob-dev/.data/content/contents.sqlite"
    },
    "integrityCheck": true
  }
};
...
const _3qp5IqNlsTr2DHFdePv5hOlVHjqP7NOlJx3_Zx5VkGY = (function(nitro) {
  nitro.hooks.hook("render:html", (htmlContext) => {
    htmlContext.head.push(`<script>${script}<\/script>`);
  });
});

const rootDir = "C:/Users/Jacob/homework/jacob-dev";

const appHead = {"meta":[{"name":"viewport","content":"width=device-width, initial-scale=1"},{"charset":"utf-8"},{"name":"description","content":"Software engineer specialising in web applications and user-centric product development."}],"link":[{"rel":"stylesheet","href":"https://fonts.googleapis.com/css2?family=EB+Garamond:ital,wght@0,400;0,500;1,400&family=DM+Mono:wght@300;400&display=swap"}],"style":[],"script":[],"noscript":[],"title":"Jacob Brewer"};
...
const _GS4qo2Z7NpUIPfckoObPtY_kVQiGZp8t0x2wmaBgyso = (nitroApp) => {
...
const plugins = [
  _3qp5IqNlsTr2DHFdePv5hOlVHjqP7NOlJx3_Zx5VkGY,
_GS4qo2Z7NpUIPfckoObPtY_kVQiGZp8t0x2wmaBgyso,
...
const _yn25Eq = eventHandler((event) => {
...
const getServerEntry = () => import('file://C:/Users/Jacob/homework/jacob-dev/.nuxt//dist/server/server.mjs').then((r) => r.default || r);
// @ts-expect-error file will be produced after app build
const getClientManifest = () => import('file://C:/Users/Jacob/homework/jacob-dev/.nuxt//dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
// -- SSR Renderer --
...
const _kRI2zO = eventHandler(async (event) => {
  ...
  return await import('file://C:/Users/Jacob/homework/jacob-dev/.nuxt/content/database.compressed.mjs').then((m) => m[collection]);
});
...
const _2GAMC3 = eventHandler(async (event) => {
...
const _lazy_XfQcUL = () => Promise.resolve().then(function () { return renderer; });

const handlers = [
  { route: '', handler: _yn25Eq, lazy: false, middleware: true, method: undefined },
  { route: '/__nuxt_error', handler: _lazy_XfQcUL, lazy: true, middleware: false, method: undefined },
  { route: '/__nuxt_island/**', handler: handler$1, lazy: false, middleware: false, method: undefined },
  { route: '/__nuxt_content/home/sql_dump.txt', handler: _kRI2zO, lazy: false, middleware: false, method: undefined },
  { route: '/__nuxt_content/work/sql_dump.txt', handler: _kRI2zO, lazy: false, middleware: false, method: undefined },
  { route: '/__nuxt_content/blog/sql_dump.txt', handler: _kRI2zO, lazy: false, middleware: false, method: undefined },
  { route: '/__nuxt_content/info/sql_dump.txt', handler: _kRI2zO, lazy: false, middleware: false, method: undefined },
  { route: '/__nuxt_content/home/query', handler: _2GAMC3, lazy: false, middleware: false, method: undefined },
  { route: '/__nuxt_content/work/query', handler: _2GAMC3, lazy: false, middleware: false, method: undefined },
  { route: '/__nuxt_content/blog/query', handler: _2GAMC3, lazy: false, middleware: false, method: undefined },
  { route: '/__nuxt_content/info/query', handler: _2GAMC3, lazy: false, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_XfQcUL, lazy: true, middleware: false, method: undefined }
];
