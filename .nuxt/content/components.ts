...
export const localComponentLoaders = {
  Navigation: () => import("./../../components/navigation.vue").then(m => pickExport(m, "default", "Navigation", "./../../components/navigation.vue")),
